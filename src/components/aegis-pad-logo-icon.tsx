// src/components/aegis-pad-logo-icon.tsx
...
const AegisPadLogoIcon: FC<AegisPadLogoIconProps> = ({ className, width = "1.75rem", height = "1.75rem" }) => {
  ...
  return (
    ...
    >
      ...
      <line x1="6" y1="8" x2="8.5" y2="8" className="stroke-primary" strokeWidth="1.25" strokeLinecap="round"/>
      <line x1="6" y1="11" x2="8.5" y2="11" className="stroke-primary" strokeWidth="1.25" strokeLinecap="round"/>
      <line x1="6" y1="14" x2="8.5" y2="14" className="stroke-primary" strokeWidth="1.25" strokeLinecap="round"/>
    </svg>
  );
};
